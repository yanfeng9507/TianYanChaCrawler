...
public class CompanyList {
    ...
    public void setClaimPkgType(String claimPkgType) {
         this.claimPkgType = claimPkgType;
     }
    ...
    public void setLegalPersonShowStr(String legalPersonShowStr) {
         this.legalPersonShowStr = legalPersonShowStr;
     }
     public String getLegalPersonShowStr() {
         return legalPersonShowStr;
     }

    public void setRegCapitalShowStr(String regCapitalShowStr) {
         this.regCapitalShowStr = regCapitalShowStr;
     }
     public String getRegCapitalShowStr() {
         return regCapitalShowStr;
     }

    public void setEstiblishTimeShowStr(String estiblishTimeShowStr) {
         this.estiblishTimeShowStr = estiblishTimeShowStr;
     }
     public String getEstiblishTimeShowStr() {
         return estiblishTimeShowStr;
     }

...
public class Data {
    ...
    public void setBrandAndAgencyList(List<BrandAndAgencyList> brandAndAgencyList) {
         this.brandAndAgencyList = brandAndAgencyList;
     }
    ...
    public void setCompanyHumanCount(int companyHumanCount) {
         this.companyHumanCount = companyHumanCount;
     }
     public int getCompanyHumanCount() {
         return companyHumanCount;
     }
